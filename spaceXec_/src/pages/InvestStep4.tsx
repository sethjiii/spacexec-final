...
const InvestStep4 = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-10 border border-gray-200">
      <h1 className="text-3xl font-bold text-gray-900 text-center mb-6">Confirm Your Investment</h1>
      ...
      {!transactionData ? (
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-300 shadow-sm mt-6">
          ...
          <h2 className="text-2xl font-semibold text-green-700 text-center mt-4">Payment Successful!</h2>
          ...
          <div className="bg-gray-50 p-4 rounded-md mt-4 text-gray-700 text-sm">
            ...
            <p><strong>Token ID:</strong> {transactionData.tokenId}</p>
            <p><strong>Issued At:</strong> {new Date(transactionData.issuedAt).toLocaleString()}</p>
            <div className="flex justify-between items-center">
              <p><strong>Signature:</strong> {transactionData.signature}</p>
              <button
                onClick={handleCopy}
